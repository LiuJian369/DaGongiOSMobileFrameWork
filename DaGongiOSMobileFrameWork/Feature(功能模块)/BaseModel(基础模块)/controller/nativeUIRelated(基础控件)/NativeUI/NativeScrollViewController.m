...
@interface NativeScrollViewController () <UIScrollViewDelegate>
...
@implementation NativeScrollViewController
...
- (NSArray *)imageNames {
    if (_imageNames == nil) {
        ...
        for (int i = 0; i < 50; i++) {
            NSString *imageName = [[NSString stringWithFormat:@"img%d", i % 5] stringByAppendingString:@".jpg"];
