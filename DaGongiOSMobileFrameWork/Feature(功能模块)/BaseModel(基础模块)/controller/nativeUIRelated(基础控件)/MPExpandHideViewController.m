...
-(void)layoutPageView // init the tableview
{
    //初始化表格
    if (!_myTableView) {  //lazy
        ...
        _myTableView.showsVerticalScrollIndicator   = NO; //vertical
        _myTableView.showsHorizontalScrollIndicator = NO; //horizon
...
//            make.edges.equalTo(self).with.insets(UIEdgeInsetsMake(0, 0, 0, 0));  //masonary can do this? :p
        }];
    }
}
