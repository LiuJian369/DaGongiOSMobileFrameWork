...
#import "deviceRelatedViewController.h"

#define  deviceRelatedViewControllerTitle @"设备相关"
@interface deviceRelatedViewController ()<UITableViewDelegate, UITableViewDataSource>
{
...
@implementation deviceRelatedViewController
...
{
    ///标签目标类
    _className = @[@"DeviceInfoViewController",
                   @"AddressViewController",
                   @"CheckNetworkViewController",
                   @"MessageCallViewController",
                   @"ScreenShotViewController",
                   @"CheckNetWorkTableViewController"
                   ];
}
...
- (void)viewDidLoad {
    ...
    self.title = deviceRelatedViewControllerTitle;
