...
#define dataPersistenceViewControllerTitle @"数据持久化"
@interface dataPersistenceViewController ()<UITableViewDelegate, UITableViewDataSource>
{
...
{
    ///标签目标类
    _className = @[@"STExploreViewController",
                   @"FMDBTableViewController"
                   ];
}
...
- (void)viewDidLoad {
    ...
    self.title = dataPersistenceViewControllerTitle;
