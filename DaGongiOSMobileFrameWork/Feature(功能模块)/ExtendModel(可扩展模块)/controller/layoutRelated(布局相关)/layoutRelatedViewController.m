...
#import "layoutRelatedViewController.h"
#define layoutRelatedViewControllerTitle @"布局相关"
@interface layoutRelatedViewController ()<UITableViewDelegate, UITableViewDataSource>
{
...
@implementation layoutRelatedViewController
...
{
    ///标签目标类
    _className = @[@"LearnAutoLayoutViewController",
                   @"MasonaryViewController"
                   ];
}
...
- (void)viewDidLoad {
    ...
    self.title = layoutRelatedViewControllerTitle;
