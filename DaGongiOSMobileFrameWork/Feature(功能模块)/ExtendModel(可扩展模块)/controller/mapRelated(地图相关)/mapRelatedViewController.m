...
#import "mapRelatedViewController.h"

#define mapRelatedViewControllerTitle @"地图相关"
@interface mapRelatedViewController ()<UITableViewDelegate, UITableViewDataSource>
{
...
@implementation mapRelatedViewController
...
- (void)viewDidLoad {
    ...
    self.title = mapRelatedViewControllerTitle;
