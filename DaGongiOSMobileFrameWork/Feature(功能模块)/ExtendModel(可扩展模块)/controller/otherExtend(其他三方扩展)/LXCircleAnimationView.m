...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.commentLabel.frame = CGRectMake(self.circelRadius / 4, self.circelRadius / 4, self.circelRadius / 2, self.circelRadius / 2);
...
//                                   nil]];
    ...
    [self.gradientLayer setLocations:@[@0.15, @0.35,@0.49,@0.55]];
    ...
    [self createAnimationWithStartAngle:degreesToRadians(self.stareAngle)
                               endAngle:degreesToRadians(self.stareAngle)];
}
