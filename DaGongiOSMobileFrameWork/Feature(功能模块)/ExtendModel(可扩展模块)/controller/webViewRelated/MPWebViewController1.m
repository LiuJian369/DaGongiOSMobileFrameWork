...
#import "MPWebViewController1.h"

@interface MPWebViewController1 ()<UIWebViewDelegate>
@property WebViewJavascriptBridge* bridge;
@property(nonatomic,strong)UIWebView *myWebView;
@end

@implementation MPWebViewController1
...
{
    NSString* htmlPath = [[NSBundle mainBundle] pathForResource:@"ExampleApp1" ofType:@"html"];
...
//    }];
    ...
    [_bridge callHandler:@"jsTestObjcCallBack" data:@[@294.9, @714.5, @106.4, @129.2, @144.0, @176.0, @135.6, @148.5, @216.4, @194.1, @95.0, @54.4]];
