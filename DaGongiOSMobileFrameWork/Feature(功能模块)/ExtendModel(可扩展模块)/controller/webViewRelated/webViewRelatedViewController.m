//
//  webViewRelatedViewController.m
...
#import "webViewRelatedViewController.h"

#define conceptRelatedViewControllerTitle @"webView"
@interface webViewRelatedViewController ()<UITableViewDelegate, UITableViewDataSource>
{
...
@implementation webViewRelatedViewController
...
{
    //标签目标类
    _className = @[@"MPWebViewController1",
                   @"f7webViewController",
                   @"JSCWebViewController",
                 //  @"JSPatchViewController"
                   ];
}
