//
//  multiThreadRelatedViewController.m
...
#import "multiThreadRelatedViewController.h"

#define multiThreadRelatedViewControllerTitle @"多线程相关"
@interface multiThreadRelatedViewController ()<UITableViewDelegate, UITableViewDataSource>
{
...
@implementation multiThreadRelatedViewController
...
{
    ///标签目标类
    _className = @[@"MultiThreadViewController"
                   ];
}
...
- (void)viewDidLoad {
    ...
    self.title = multiThreadRelatedViewControllerTitle;
